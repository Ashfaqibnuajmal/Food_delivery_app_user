  ...
  void initState() {
    ...
    context.read<FoodSearchBloc>().stream.listen((state) {
      ...
      if (state.query.isNotEmpty) {
        ...
        context.read<FoodCategoryFilterCubit>().clearCategory();
      }
    });
  }
                          ...
                          child: Column(
                            children: [
                              InkWell(
                                ...
                                child: BlocBuilder<FoodCategoryFilterCubit,
                                    String?>(
