...
class OrderHistory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final steps = [
      ...
      {"title": "Out Of Delivery", "icon": Icons.delivery_dining},
      {"title": "Delivered", "icon": Icons.check_circle},
    ];

    Widget buildStep(Map<String, Object> step,
        {required bool isLast, bool isActive = false}) {
      return Row(
          ...
          children: [
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                final currentStatus =
                    (data['orderStatus'] ?? 'Making').toString();

                int activeIndex =
                    steps.indexWhere((s) => s['title'] == currentStatus);
